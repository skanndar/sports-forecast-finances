...
export const tooltips: TooltipContent = {
  ...
  "director-costs": "Comisión pagada al Director como porcentaje de la facturación total.",
  ...
  "capex-plan": "Plan de inversiones adicionales por año después de la inversión inicial.",
